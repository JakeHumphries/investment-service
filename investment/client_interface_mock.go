...
func (_m *MockClientInterface) GetFunds(ctx context.Context, customerType string) ([]models.Fund, error) {
...
//   - ctx context.Context
//   - customerType string
func (_e *MockClientInterface_Expecter) GetFunds(ctx interface{}, customerType interface{}) *MockClientInterface_GetFunds_Call {
	return &MockClientInterface_GetFunds_Call{Call: _e.mock.On("GetFunds", ctx, customerType)}
}

func (_c *MockClientInterface_GetFunds_Call) Run(run func(ctx context.Context, customerType string)) *MockClientInterface_GetFunds_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClientInterface_GetFunds_Call) RunAndReturn(run func(context.Context, string) ([]models.Fund, error)) *MockClientInterface_GetFunds_Call {
	_c.Call.Return(run)
	return _c
}
